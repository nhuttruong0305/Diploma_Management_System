...
export default function RequestReissueForSecretary(){
    ...
    const noti = useRef();
    //Hàm cập nhật trạng thái thành "Đã gửi thủ kho"
    const updateRequestReissueForSecretary = async () => {
        try{
            const updateDoc = {
        ...
        allUserAccount?.forEach((user)=>{
            ...
            if(user.role[0] == "Stocker"){
                allUserStocker = [...allUserStocker, user]
            }
            if(user.mssv_cb == _IdRequestReissue.mscb_approve){
                nguoi_duyet = user.fullname;
            }
        })
        //gửi mail cho thủ kho biết
        for(let i = 0; i<allUserStocker.length; i++){
            try{
                const mailOptions = { 
                    to: allUserStocker[i].email,
                    subject: "Một yêu cầu xin cấp lại phôi mới cần xử lý",
                    html: `<div style='background-color: #f3f2f0; padding: 50px 150px 50px 150px; color: black;'>
                            <div style='background-color: white;'>
                                ...
                                <h1 style='text-align: center; font-size: 24px; padding: 15px;'>
                                    Một yêu cầu xin cấp lại phôi mới cần xử lý
                                </h1>
                                <hr />
        ...
        try{
            const mailOptions = { 
                to: email_cb_tao_yc,
                subject: "Yêu cầu xin cấp lại phôi của bạn đã được gửi cho thủ kho",
                html: `<div style='background-color: #f3f2f0; padding: 50px 150px 50px 150px; color: black;'>
                        <div style='background-color: white;'>
                            <div>
                                <img
                            ...
                            <h1 style='text-align: center; font-size: 24px; padding: 15px;'>
                                Yêu cầu xin cấp lại phôi của bạn đã được gửi cho thủ kho
                            </h1>
                            <hr />
                            <h3 style='text-align: center;'>Chi tiết yêu cầu</h3>
                            <div style='padding: 0px 25px 10px 25px;'>
    ...
    return(
                ...
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <div className="card p-3">
                            ...
                            <div className="row mt-3">
                                <p className='title-list-yc-xin-cap-phoi'>DANH SÁCH CÁC YÊU CẦU XIN CẤP LẠI PHÔI ĐÃ ĐƯỢC DUYỆT</p>
                            </div>
                            <div className="row mt-3 p-3">
                                <div id="contain-request-reissue-forsecretary">
                                    <table 
                                                ...
                                                allRequestReissue_PT?.map((currentValue, index)=>{
                                                    ...
                                                    return(
                                                        <tr key={index}>
                                                            ...
                                                            <td>
                                                                {
                                                                    //nút cập nhật trạng thái thành "Đã gửi thủ kho"
                                                                    currentValue.status == "Đã duyệt yêu cầu" ? (
                                                                        <i 
                                                                            className="fa-solid fa-pen-to-square"
                                                                            style={{backgroundColor: "#fed25c", padding: '7px', borderRadius: '5px', color: 'white'}}  
                                                                            data-bs-toggle="modal" data-bs-target="#modalUpdateRequestReissueForSecretary" 
                                                                            onClick={(e)=>{
                                ...
                                {/* Modal cập nhật trạng thái thành "Đã gửi thủ kho"             */}
                                <div className="modal fade" id="modalUpdateRequestReissueForSecretary" tabIndex="-1" aria-labelledby="modalUpdateRequestReissueForSecretaryLabel" aria-hidden="true">
                                    <div className="modal-dialog modal-dialog-centered">
                                        <div className="modal-content">
                                        <div className="modal-header">
                                            <h1 className="modal-title fs-5" id="modalUpdateRequestReissueForSecretaryLabel"></h1>
                                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div className="modal-body">
                                            <h5>Bạn có chắc muốn cập nhật trạng thái của yêu cầu xin cấp lại phôi này thành <span style={{fontWeight: 'bold'}}>"Đã gửi thủ kho"</span></h5>
                                        </div>
                                        <div className="modal-footer">
                                            ...
                                            <button 
                                                ...
                                                onClick={(e)=>{
                                                    updateRequestReissueForSecretary()
                                                }}
                                            >Cập nhật</button>
                                        </div>
                                        </div>
        ...
        <Footer/>
        <Toast
            message='Cập nhật trạng thái yêu cầu thành "Đã gửi thủ kho" thành công'
            type="success"
            ref={noti}
        />
        </>
